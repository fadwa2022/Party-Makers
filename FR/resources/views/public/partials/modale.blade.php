...
<div class="modal opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center ">
  ...
  <div class="modal-container bg-white  mx-auto rounded shadow-lg z-50 overflow-y-auto">
    ...
    <div class="modal-content py-4 text-left px-6 w-full bg-cover h-screen bg-no-repeat " style="background-image:url('{{ asset('storage/'.$Style->image_style) }}') ;    background-size: 100% 100%;    ">
      <!--Title-->
      <div class="flex justify-between items-center pb-3">
        <p class="text-2xl font-bold text-white">{{$Style->style_name}}</p>
